...
{
    protected static final Identifier BUTTON_TEXTURE = Identifier.of("widget/button");
    protected static final Identifier BUTTON_DISABLE_TEXTURE = Identifier.of("widget/button_disabled");
    protected static final Identifier BUTTON_HOVER_TEXTURE = Identifier.of("widget/button_highlighted");
