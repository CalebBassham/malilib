...
{
    public static final Identifier BUTTON_TEXTURE = Identifier.of("widget/button");
    public static final Identifier BUTTON_DISABLE_TEXTURE = Identifier.of("widget/button_disabled");
